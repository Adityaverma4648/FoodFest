...
axesHelper.rotation.y = 8;

// Animate the drone and package moving from right to left
function animate() {
  requestAnimationFrame(animate);


//   // Move the group from right to left
//   if (droneGroup.position.x > -50) { // Adjust the stopping point as needed
...
//   // Reset position to right if it moves out of view
